...
<html>  
    ...
    <body>
            <header class="container">
                <div id="logo">
                    <a href="/" class="flex items-center no-underline text-brand">
                        ...
                        <span class="text-xl ml-3" style="color:orange">Laravel</span>
                    </a>
                </div>
                <div id="menu">     
            ...
            <footer style="clear:both">
                ...
                <span>Follow the <a style="text-decoration:underline" href="">RSS Feed</a></span>
                <a href="/en">
                        <img src="{{ asset('images/American.png') }}"  width="20px" height="10px" >English
                        </a> 
                        <a href="/jp">
                            <img src="{{ asset('images/Japan.jpg') }}"  width="20px" height="10px" >Japan
                        </a>
            </footer>
    </body>
</html>